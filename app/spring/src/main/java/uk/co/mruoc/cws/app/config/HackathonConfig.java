...
public class HackathonConfig {
    ...
    @Bean
    public HackathonFacade hackathonFacade(HackathonClient hackathonClient, CrosswordSolverFacade solverFacade) {
    ...
    @Bean
    public HackathonClient hackathonApiClient(@Value("${hackathon.base-url}") String url, JsonMapper jsonMapper) {
