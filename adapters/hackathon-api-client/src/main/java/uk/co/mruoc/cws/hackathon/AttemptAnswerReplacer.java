...
public class AttemptAnswerReplacer {
    ...
    private Answers replaceAnswersIfRequired(Puzzle puzzle, Answers answers) {
        return new Answers(answers.stream().map(answer -> replaceAnswerIfRequired(puzzle, answer)).toList());
    }
    ...
    private static Map<String, String> buildReplacementAnswers() {
        return Map.of("puzzle3.png-6D-HYGIENE", "HYGEINE",
                "puzzle9.jpg-27D-INOCULATED", "INOCULATE",
                "puzzle9.jpg-24D-ESMERALDA", "ESMERELDA",
                //"puzzle9.jpg-41D-RECITAL", "?", need to find alternative answer for this one
                "puzzle14.jpg-25D-ADVOCAAT", "ADVOCAT");
    }
}
